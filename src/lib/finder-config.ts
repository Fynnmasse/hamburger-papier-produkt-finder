...
export const CATEGORIES: CategoryDef[] = [
  {
    ...
    metaTitle: 'Toilettenpapier B2B Großhandel | Hamburgpapier Produktfinder',
  ...
  },
  {
    ...
    metaTitle: 'Papierhandtücher B2B kaufen | Hamburgpapier Produktfinder',
  ...
  },
  {
    ...
    metaTitle: 'Handtuchrollen B2B bestellen | Hamburgpapier Produktfinder',
...
export function getCurrentStep(
  ...
  // Wenn 0 echte Optionen übrig → Step überspringen
  // Bei 1 Option: trotzdem zeigen, damit nachfolgende Steps erreichbar bleiben
